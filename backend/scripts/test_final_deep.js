...
async function testDeepRoutes() {
  ...
  const roles = [
    { label: 'Admin', username: 'admin', password: 'admin123', route: '/api/dashboard/' },
    { label: 'Teacher', username: 'teacherjoe', password: 'joe123', route: '/api/attendance/' }, // Teachers can access attendance
    { label: 'Parent', username: 'parent@test.com', password: 'parent123', route: '/api/parents/profile' }
  ];

  console.log('--- FINAL DEEP ROUTE VERIFICATION ---');
